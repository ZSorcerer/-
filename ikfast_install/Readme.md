...
还有一种方法是使用数值解，目前数值解求解速度最快的是Track-ik, UR5机器人使用Track-ik求解时间差不多400~500微秒，而且Track-ik可以使用出厂校准后的DH参数进行数值求解(相关资料可以在[https://github.com/UniversalRobots/Universal_Robots_ROS_Driver/issues/226](https://github.com/UniversalRobots/Universal_Robots_ROS_Driver/issues/226) 找到)，但是需要依赖ROS。
